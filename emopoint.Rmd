...
ggplot()+
  ...
  geom_dotplot(data = props,aes(x = unique_group, y = corr),fill = "grey", binaxis = "y", stackdir = "centerwhole", binpositions="all", binwidth = .015, alpha = .5)+
...
```{r}
ggsave("plots/data.pdf", width = 20, height = 8, scale = 1, dpi = 2000, units = "cm")
```
